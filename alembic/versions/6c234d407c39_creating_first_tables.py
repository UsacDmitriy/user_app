...
Revision ID: 6c234d407c39
Revises: 
Create Date: 2022-10-28 12:45:43.176371
...
def upgrade() -> None:
    ...
    op.create_index('like_post_user_id_idx', 'liked_post', ['user_id'], unique=False)
    # ### end Alembic commands ###


def downgrade() -> None:
    # ### commands auto generated by Alembic - please adjust! ###
    op.drop_index('like_post_user_id_idx', table_name='liked_post')
